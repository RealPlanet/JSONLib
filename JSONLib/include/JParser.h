...
namespace json
{
	...
	private:
		...
		std::unique_ptr<JElement> parse_json_value(DataIterator& it);
		std::unique_ptr<JElement> parse_json_array(DataIterator& it);
		std::unique_ptr<JElement> parse_json_object(DataIterator& it);

		std::unique_ptr<JElement> parse_boolean(DataIterator& it);
		std::unique_ptr<JElement> parse_number(DataIterator& it);
		...
		std::tuple<std::string, std::unique_ptr<JElement>> parse_member(DataIterator& it);
